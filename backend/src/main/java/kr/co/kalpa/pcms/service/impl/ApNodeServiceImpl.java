...
import kr.co.kalpa.pcms.mapper.ApFileMapper;
import kr.co.kalpa.pcms.mapper.ApNodeMapper;
import kr.co.kalpa.pcms.service.ApNodeService;
...
public class ApNodeServiceImpl implements ApNodeService {
    ...
    public ApNodeDto uploadFile(String parentId, MultipartFile file) throws IOException {
        ...
        // 이미지 메타데이터 (JDK ImageIO, 추가 라이브러리 불필요)
        Integer width = null;
        Integer height = null;
    ...
    /** 노드 타입에 따라 파일/링크 정보를 resolve하여 ApNodeDto 반환 */
