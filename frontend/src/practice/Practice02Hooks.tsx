  ...
  return (
    <section className="p-6 border rounded-xl bg-white shadow-sm">
      ...
      <div className="flex items-center gap-4">
        ...
        <span className="text-2xl font-mono w-16 text-center">0</span>
...
function Timer() {
  ...
  useEffect(() => {
    // TODO 3-3: running이 true일 때만 1초 간격으로 seconds를 증가시키세요
    //   setInterval 사용
    //   cleanup에서 clearInterval 호출

    // 힌트:
    // if (!running) return
    // const id = setInterval(() => setSeconds(prev => prev + 1), 1000)
    // return () => clearInterval(id)
  }, [/* TODO: deps에 무엇을 넣어야 할까요? */])
  ...
  return (
    <section className="p-6 border rounded-xl bg-white shadow-sm">
      ...
      <div className="flex items-center gap-4">
        {/* TODO: seconds 값 표시 */}
        <span className="text-3xl font-mono">0초</span>
        {/* TODO: 시작/정지 토글 버튼 */}
    ...
    <section className="p-6 border rounded-xl bg-white shadow-sm">
      ...
      <div className="relative inline-block">
        <button
          ...
          // TODO: onClick으로 open 토글
        >
          메뉴 열기
        </button>

        {/* TODO 4-5: open이 true일 때만 보이도록 조건부 렌더링 */}
        <div className="absolute left-0 mt-2 w-40 bg-white border rounded-lg shadow-lg p-2 space-y-1">
