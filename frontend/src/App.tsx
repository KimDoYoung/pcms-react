...
import DiaryRegisterPage from './diary/DiaryRegisterPage'
import DiaryViewPage from './diary/DiaryViewPage'
...
import PostsPage from './board/PostsPage'
import PostNewPage from './board/PostNewPage'
import PostViewPage from './board/PostViewPage'
import PostEditPage from './board/PostEditPage'
import ApNodePage from './apnode/ApNodePage'
